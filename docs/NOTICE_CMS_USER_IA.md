...
- 普通用户“公告中心入口”放在哪个页面暂未确定。
- 因此本文件中与“正式主入口”相关内容保留为长期目标，不作为本轮必须落地项。
- 本轮优先保证：
  - modal 能正确拉取与展示
  - modal 能稳定进入详情
  - 详情页能承接 `read / acknowledged`
  - 后续入口一旦确定，再把公告中心入口接回用户主流程
...
- 即使公告中心入口未接入，modal 也必须能独立完成“提醒 -> 详情 -> 已读/确认”的闭环。
