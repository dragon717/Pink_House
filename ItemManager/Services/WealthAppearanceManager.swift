...
enum WealthExperienceCopy {
    ...
    enum Counting {
        static let sourceLine = "衣橱总值 + 心愿尾款定金"
    ...
    enum VIP {
        static let benefitSubtitle = "纸币背景"
        static let ownedMessage = "你已拥有来财个性化权益。可在「我 → 马上来财设置」中继续自定义纸币与背景样式。"
        static let lockedMessage = "开通 VIP 后即可解锁来财纸币与背景样式自定义能力。"
    }
