    ...
    static func profile(for role: PetRole, petName: String) -> PetPersonaProfile {
        ...
        case .kitten:
            return PetPersonaProfile(
                ...
                errorReplies: [
                    "（挠挠耳朵）我刚刚绊了一下喵，咱们再试一次，我会更认真听你说。".appLocalized,
                    "（小声喵）这次没发挥好，但我还在，换个说法我马上接住你。".appLocalized
                ],
                keyMissingReply: "（抱住你）我现在还连不上云端大脑，先去「智能萌宠设置」检查密钥，回来我就继续陪你。".appLocalized
            )
        case .goldenRetriever:
            return PetPersonaProfile(
                ...
                errorReplies: [
                    "（委屈但努力）这次我摔了一跤汪，再给我一次机会，我会接得更稳。".appLocalized,
                    "（贴贴）我还在这儿，换一种说法我们继续，保证不让你一个人想。".appLocalized
                ],
                keyMissingReply: "（急得摇尾巴）我现在还连不上云端大脑，先去「智能萌宠设置」检查密钥，回来我就继续帮你！".appLocalized
            )
        }
    }
}
